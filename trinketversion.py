...
def interpret():
    file_name = 'text.txt' # so you can use this Terminal command: python interpreter.py text.txt
    ...
    for phrase_start in spell_checkphrases:
        for phrase_stop in spell_finish_words:
            ...
            if matches:
                ...
                print('\n  DEBUG SPELL: spelt_word=' + spelt_word)
                # print(sentence)
...
def check_variable(sentence):
    ...
    if matches:
        ...
        print('\n  DEBUG variable_dictionary: ' + str(variable_dictionary))
    ...
    for i in range(len(words)):
        ...
        if word in math_words_numbers:
            ...
            try:
                ...
                print('\n  DEBUG MATH: ' + math_expression + ' = ' + str(math_result))
                print('\n  DEBUG MATH: replace_expression = ' + replace_expression)
...
def check_import(sentence):
    ...
    if matches:
        ...
        print('\n  DEBUG IMPORT: IMPORT_DICTIONARY, size = ' + str(len(import_dictionary)) + '\n\t = ' + str(import_dictionary))
    else:
        checkphrase = '.*import (.+)'
        matches = re.match(checkphrase, sentence)
        if matches:
...
def check_use(sentence):
    ...
    if matches:
        ...
        print('\n  DEBUG USE: ' + use_string + ' from ' + from_string)
...
print() # blank line to separate things

if variable_dictionary:
