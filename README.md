...
No speech recognition software? No Python? Just type code in your browser: https://trinket.io/python3/b8e858725f (go to the text.txt tab to write code in Please).
