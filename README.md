...
No speech recognition software? No Python? Just type code in your browser: https://trinket.io/python/b02a41eef5 (go to the text.txt tab to write code in Please).
