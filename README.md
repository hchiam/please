...
No speech recognition software? No Python? Just type code in your browser: https://trinket.io/python3/801aa82b3e (go to the text.txt tab to write code in Please).
