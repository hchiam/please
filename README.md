...
I want to try to create an experimental programming language that can use (i.e. parse) text generated by speech recognition software like Mac Dictation, so you can code by talking.
