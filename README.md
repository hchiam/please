...
No speech recognition software? No Python? Just type code in your browser: https://trinket.io/python3/2e54691927 (go to the text.txt tab to write code in Please).
